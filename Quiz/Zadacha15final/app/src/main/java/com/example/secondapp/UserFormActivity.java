...
public class UserFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = (User) getIntent().getSerializableExtra("user"); //принимаем интент от UserInfoActivity
        ...
        insertUserBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (user!= null) users.updateUser(user); //если !=null редактируем пользователя
               // else {users.addUser(null);}
                else user=null;
                users.addUser(user);
                onBackPressed();
            }
